...
document.addEventListener('DOMContentLoaded', function () {
  ...
  if (localStorage.getItem('sidebarCollapsed') === 'true' && window.innerWidth > 768) {
    ...
    if (elements.mainWrapper) elements.mainWrapper.classList.add('full-width');
  }
  ...
  function closeSearchBar() {
    if (elements.searchForm) elements.searchForm.classList.remove('active');
    if (elements.searchBackdrop) elements.searchBackdrop.classList.remove('active');
    if (elements.searchToggle) {
  ...
  document.addEventListener('keydown', function (e) {
    if (e.key === 'Escape' && elements.searchForm && elements.searchForm.classList.contains('active')) {
      closeSearchBar();
    }
  });
  ...
  window.addEventListener('resize', function () {
    ...
    resizeTimer = setTimeout(function () {
      if (window.innerWidth > 768) {
        ...
        if (elements.mainWrapper) elements.mainWrapper.classList.remove('full-width');
      }
    }, 250);
  });
  ...
  // ========================================
  // SUBMENU FUNCTIONALITY (¡IMPORTANTE!)
  // ========================================
    ...
    toggle.addEventListener('click', function (e) {
      ...
      if (targetElement && typeof bootstrap !== 'undefined') {
        ...
        if (isShown) {
          ...
          // Intenta obtener la instancia existente o crea una nueva si no existe
  ...
  navLinks.forEach((link) => {
    ...
    // Simple check to see if URL matches
